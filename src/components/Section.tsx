      ...
      {props.transparency ? (
        <div className="max-w-[1440px] m-auto">
          <div className="max-w-[1440px] font-[400] p-[48px] m-auto mt-[50px] rounded-[24px] bg-[#fff] shadow-[0_4px_8px_8px_0px_rgba(0,0,0,0.04)]">
            <div>
              The integrity and long-term trust of the GBPC stablecoin ecosystem
              ...
              fiat-backed digital assets. All GBP reserves backing GBPC at a 1:1
              ratio are securely held in segregated accounts across multiple
              trusted financial institutions. This ensures that every GBPC token
              in circulation is fully supported by verifiable fiat reserves.
            </div>
            <div className="mt-3">
              Transparency is at the core of GBPC’s design, users can
              independently verify the total circulating supply of GBPC on-chain
              ...
              that every GBPC token in circulation is fully backed by fiat
