    ...
    >
      <div className=" flex gap-[90px] pl-[22px] pr-[105px]">
        <div className="flex-1">
          ...
          <div className="mt-10 p-4 border border-[#505050] rounded-lg">
            ...
            <div className="flex leading-8 items-start gap-4 text-sm justify-between">
              ...
              <div className="text-[#202B4B] gap-2 flex items-center justify-end text-right flex-1">
                {bankInfo.address}
                <CopyOutlined
                  className="cursor-pointer"
                  onClick={() => {
          ...
          <div className="flex mt-[30px] leading-8 items-start gap-4 text-sm justify-between">
            <div className="text-[#A3ABC0]">Arrive Time </div>
            <div className="text-[#202B4B] gap-2 flex items-center justify-end text-right flex-1">
              1-2 business days
            </div>
          </div>
          <div className="flex leading-8 items-start gap-4 text-sm justify-between">
            <div className="text-[#A3ABC0]">Fee </div>
            <div className="text-[#202B4B] gap-2 flex items-center justify-end text-right flex-1">
              0.1%
            </div>
          </div>
          <div className="flex leading-8 items-start gap-4 text-sm justify-between">
            <div className="text-[#A3ABC0]">Minimum amount </div>
            <div className="text-[#202B4B] gap-2 flex items-center justify-end text-right flex-1">
              100,000 {currency || '£'}
            </div>
          </div>
        ...
        <div className="w-[285px]">
          <div className="text-[18px] font-bold leading-8 text-[#202B4B]">
            How it works
          </div>
