      ...
      <div className="px-[16px] py-[15px]">
        ...
        {!!addressObj.id ? null : (
          <>
            ...
            <div className="text-sm leading-[22px] text-black mb-3">
              On-chain Transfer
            </div>
          </>
        )}
        ...
        >
          <Form form={form} size="large">
            ...
            <div className="register-input flex items-center mb-3">
              <img src={gbpc} className="w-[22px] h-[22px] mr-3" /> GBPC
            </div>

            <Form.Item hidden name="currency" initialValue="GBPC"></Form.Item>
            ...
            >
              <Select
                ...
                dropdownRender={(menu) => (
                  <>
                    <div className="px-[16px] py-[12px] m-[16px] bg-[#FFA60014] leading-[22px] border-[1px] border-[#F3974F] rounded-lg text-[#EE6700] text-sm">
