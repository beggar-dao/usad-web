      ...
      <div className="w-[588px] relative m-auto rounded-[16px] pt-[40px] border border-[#505050]">
        ...
        <div className="flex h-[700px] flex-col justify-center items-center">
          <div>
            ...
            <div className="text-center mt-6 font-bold text-[#202B4B] text-[24px]">
              Your {searchParams.get('type') === 'kyb' ? 'KYB' : 'KYC'} has been
              submitted for verification
            </div>
            <div className="text-center mt-3 text-[#202B4B] text-[14px] leading-[22px]">
            ...
            <div
              ...
              className="w-[270px] m-auto !mt-[60px] cursor-pointer hover:opacity-[90] transition-all h-[48px] bg-[#202B4B] rounded-lg leading-[48px] text-center text-white font-bold"
            >
              Check Status
            </div>
          </div>
